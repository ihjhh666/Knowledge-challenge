  ...
  return (
    <div className="absolute inset-0 bg-[#0a0a16] flex flex-col font-sans overflow-hidden touch-none overscroll-none" dir="rtl">
        ...
        <header className="absolute top-0 left-0 right-0 p-4 flex items-center justify-between z-10 pointer-events-none">
            <button 
                onClick={() => navigate('/')} 
                className="pointer-events-auto h-12 px-5 bg-slate-900/80 backdrop-blur-md rounded-full border border-slate-700/50 hover:bg-slate-800 flex items-center gap-2 transition-all shadow-lg hover:shadow-black/50"
            >
                <ArrowRight className="w-5 h-5 text-slate-300" />
                <span className="text-white font-bold text-sm hidden sm:inline">خروج</span>
            </button>
