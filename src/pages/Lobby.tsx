                    ...
                    if (p) {
                       return (
                         <div key={p.id} className="bg-blue-900/30 border border-blue-500/50 p-3 rounded-2xl flex items-center justify-between">
                            <div className="flex items-center gap-3 cursor-pointer hover:opacity-80" onClick={() => window.dispatchEvent(new CustomEvent('open_player_profile', { detail: p.userId || p.id }))}>
