...
let bgCanvasCaches: Record<string, HTMLCanvasElement> = {};
const getBgCanvas = (is2v2: boolean) => {
   const CANVAS_WIDTH = is2v2 ? 550 : 400;
   const CANVAS_HEIGHT = is2v2 ? 850 : 700;
   const GOAL_WIDTH = is2v2 ? 200 : 140;

   const key = is2v2 ? '2v2' : '1v1';
   if (bgCanvasCaches[key]) return bgCanvasCaches[key];
...
export default function HockeyRoom() {
  ...
  const draw = (ctx: CanvasRenderingContext2D) => {
    ...
    ctx.drawImage(getBgCanvas(false), 0, 0);
