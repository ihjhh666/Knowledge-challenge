...
const CLUBS = [
  ...
  { n: 'يوفنتوس', c: 'إيطاليا', cl: 2 }, { n: 'أياكس', c: 'هولندا', cl: 4 },
  { n: 'إنتر ميلان', c: 'إيطاليا', cl: 3 }, { n: 'تشيلسي', c: 'إنجلترا', cl: 2 },
  { n: 'بورتو', c: 'البرتغال', cl: 2 }, { n: 'بنفيكا', c: 'البرتغال', cl: 2 },
  { n: 'بروسيا دورتموند', c: 'ألمانيا', cl: 1 }, { n: 'مارسيليا', c: 'فرنسا', cl: 1 },
  { n: 'نوتنغهام فورست', c: 'إنجلترا', cl: 2 }, { n: 'آيندهوفن', c: 'هولندا', cl: 1 },
  { n: 'النجم الأحمر', c: 'صربيا', cl: 1 }, { n: 'ستيوا بوخارست', c: 'رومانيا', cl: 1 }
];
